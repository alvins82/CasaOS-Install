...
readonly CASAOS_INSTALL_RELEASE_TAG="v0.4.35"
...
readonly CASAOS_APP_MANAGEMENT_SHA256_AMD64="7c0c19f0652db62bb643691ca5bafefe5f06ed360239f2de14ce32858464d14a"
readonly CASAOS_APP_MANAGEMENT_SHA256_ARM64="5fb68d271f59908c054d5b79dd9fa8fbddd96bf2d49575bb183f72faf2668d4c"
readonly CASAOS_APP_MANAGEMENT_SHA256_ARM7="df95c5b4687b94b77d20230a543f5504c58dd720adbd3904a4e1b8af2f05a72f"
...
readonly CASAOS_COMPAT_OVERLAY_SHA256="0fba6af14f96b3d8c0bc4d4c8bb6c1ce0e949ceccba06a47764bdbbf4f4a202a"
...
Detach_From_CasaOS_Service() {
    ...
    if [[ "${CASAOS_INSTALLER_DETACHED:-0}" == "1" ]]; then
        return 0
    fi
    Running_Under_CasaOS_Service || return 0
...
"${CASA_DOWNLOAD_DOMAIN}alvins82/CasaOS-LocalStorage/releases/download/v0.4.25/linux-${TARGET_ARCH}-casaos-local-storage-v0.4.25.tar.gz"
...
Install_Optional_SMB_Discovery_Package() {
    ...
    Show 2 "Install optional SMB discovery dependency: \e[33m${package_name}\e[0m"
    GreyStart
...
DownloadAndInstallCasaOS() {
    if [ -z "${BUILD_DIR}" ]; then
        ...
        Verify_Fork_Package \
            ...
            "${CASAOS_CORE_SHA256}"
        Verify_Fork_Package \
            "${CASAOS_COMPAT_OVERLAY_FILE}" \
            "${CASAOS_COMPAT_OVERLAY_SHA256}"
